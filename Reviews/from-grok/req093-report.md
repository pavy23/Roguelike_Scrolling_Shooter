...
9차 사람 피드백 7항목 데이터 반영 완료 (**그레이즈 콤보 게인도 사람 승인 후 1→3 반영**).  
검증 전부 통과.
...
## 7. 그레이즈 콤보 게인 — **사람 승인 반영 (1→3)**

| 항목 | 이전 | 확정 |
|---|---:|---:|
| `scoring.json.grazeGaugeCharge` | **1** | **3** |

- **2026-08-01 사람 승인:** REQ-093 §7 제안 단건 승인 — `grazeGaugeCharge` **1→3** 반영.
...
- 60s 스케치에서 grazeShare가 40% 하드 게이트에 근접할 수 있어, BalanceSim으로 재검.
