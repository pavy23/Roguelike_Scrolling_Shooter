...
namespace Shmup.Core.Tests
{
    ...
    {
        [Test]
        public void DefaultProgressionUsesSixBosslessRoomsThenBiomeBoss()
        {
            ...
            Assert.AreEqual(6, run.RoomsPerBiome);
