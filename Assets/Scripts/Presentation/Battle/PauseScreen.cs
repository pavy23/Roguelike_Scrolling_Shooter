    ...
    public sealed class PauseScreen : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (touch)
            {
                ...
                // **좌측 상단**이다 (사람 지시 2026-08-04). 상단 중앙은 보스 HP 바
                // 자리라 비켜야 했고, 좌하단으로 한 번 갔다가 좌상단으로 확정됐다.
                //
                // 여기 있던 진행도·계약 표시는 오른쪽으로 밀었다 (ProgressHud) —
                // 버튼은 손가락이 닿는 자리가 정해져 있지만 글자는 어디로든 갈 수 있다.
